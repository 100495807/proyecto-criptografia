...
class SecurityManager:
    ...
    def encrypt_aes_gcm(self, plain_text, key, nonce):
    ...
    def decrypt_aes_gcm(self, cipher_text_b64, key, nonce):
    ...
    def sign_comment(self, private_key_pem, comment):
    ...
    def verify_comment_signature(self, public_key_pem, comment, signature):
    ...
    def create_root_ca(self, user_type):
    ...
    def create_subordinate_ca(self, root_key, root_cert, user_type, CERT_FOLDER):
    ...
    def user_certificate(self, sub_key, sub_cert, user_name, master_password, salt):
    ...
    def verify_certificate(self, user_cert, sub_cert):
        try:
    ...
    def encrypt_private_key(self, private_key, key, nonce):
        cipher = Cipher(algorithms.AES(key), modes.GCM(nonce), backend=default_backend())
        encryptor = cipher.encryptor()
    ...
    def decrypt_private_key(self, encrypted_private_key_b64, key, nonce):
        try:
    ...
    def save_private_key(self, cert_name, private_key, master_key):
    ...
    def get_private_key_from_db(self, cert_name):
        conn = sqlite3.connect('database.db')
        cursor = conn.cursor()
    ...
    def certificate_exist(self, cert_name):
        conn = sqlite3.connect('database.db')
        cursor = conn.cursor()
        cursor.execute('''
